...
#     ModelCheckpoint('telugu_transliteration.h5', monitor='val_loss', save_best_only=True),
...
#model.save('telugu_transliteration_model.keras')
model = load_model('telugu_transliteration_model.keras')
